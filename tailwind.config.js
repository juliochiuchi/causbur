  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "causbur-text-title-item": "#fff",
        "causbur-text-informative": "#94a3b8",
        "causbur-text-total": "#fff",
        "causbur-text-value-total": "#a3e635",
        "causbur-background-input": "#1e293b",
        "causbur-text-input": "#fff",
        "causbur-text-quantity": "#94a3b8",
      },
    },
  },
  plugins: [],
